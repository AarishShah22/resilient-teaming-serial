# Resilient Teaming Project - Serial Communication Library
...
This is the Serial library for the Resilient Teaming project with the Barton Research Group at the University of Michigan. This is a cross-platform library for interfacing with rs-232 serial like ports written in C++. It provides a modern C++ interface with a workflow designed to look and feel like PySerial, but with the speed and control provided by C++. 
